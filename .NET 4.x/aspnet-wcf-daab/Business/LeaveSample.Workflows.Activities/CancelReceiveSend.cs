...
namespace LeaveSample.Workflows.Activities
{
    ...
    public class CancelReceiveSend : MessagingWrapperActivity, IActivityTemplateFactory
    {
        public Activity Create(DependencyObject target)
        {
            ...
            receive.Action = "http://tempuri.org/ILeaveWorkflowService/Cancel";
            ...
            send.Action = "http://tempuri.org/ILeaveWorkflowService/CancelResponse";
            send.Request = receive;
            send.PersistBeforeSend = true;

            // Add parameters to SendReply
            var sendParameters = new SendParametersContent();
            sendParameters.Parameters.Add("CancelResponseResult", new InArgument<Leave>(leave));
