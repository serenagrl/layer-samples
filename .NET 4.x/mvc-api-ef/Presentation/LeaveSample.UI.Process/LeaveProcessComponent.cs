...
namespace LeaveSample.UI.Process
{
    ...
    /// </summary>
    public partial class LeaveProcessComponent : ProcessComponent
    {
        /// <summary>
        ...
        public Leave GetLeaveById(long leaveID)
        {
            ...
            var result = HttpGet<Leave>("Leave/GetLeaveById", values, MediaType.Json);
        ...
        public List<LeaveStatusLog> ListLogsByLeave(long leaveID)
        {
            ...
            result = HttpGet<List<LeaveStatusLog>>("Leave/ListLogsByLeave", values, MediaType.Json);
